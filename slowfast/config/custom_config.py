...
def add_custom_config(_C):
    ...
    _C.MODEL.TEACHER_DETECTION = False
    _C.MODEL.TIP_CACHE_DIR = '/root/autodl-tmp/FROSTER_main/models/tip_cache'
    _C.MODEL.TIP_SHOTS = 8
    _C.MODEL.ARCH = 'ViT-L/14'
    _C.DATA.CLIP_CACHE_DIR = 'E:/python projects/temp-model/cache'
    # pass
